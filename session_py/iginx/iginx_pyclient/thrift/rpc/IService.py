...
class Iface(object):
    ...
    def commitTransformJob(self, req):
        """
        Parameters:
         - req
    ...
    def queryTransformJobStatus(self, req):
        """
        Parameters:
         - req
...
class Client(Iface):
    ...
    def loadUDF(self, req):
        ...
        """
        self.send_loadUDF(req)
        return self.recv_loadUDF()

    def send_loadUDF(self, req):
        self._oprot.writeMessageBegin('loadUDF', TMessageType.CALL, self._seqid)
        args = loadUDF_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_loadUDF(self):
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            iprot.readMessageEnd()
            raise x
        result = loadUDF_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "loadUDF failed: unknown result")
    ...
    def commitTransformJob(self, req):
        ...
        """
        self.send_commitTransformJob(req)
        return self.recv_commitTransformJob()

    def send_commitTransformJob(self, req):
    ...
    def queryTransformJobStatus(self, req):
        ...
        """
        self.send_queryTransformJobStatus(req)
        return self.recv_queryTransformJobStatus()

    def send_queryTransformJobStatus(self, req):
        self._oprot.writeMessageBegin('queryTransformJobStatus', TMessageType.CALL, self._seqid)
        args = queryTransformJobStatus_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_queryTransformJobStatus(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = queryTransformJobStatus_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
    ...
    def cancelTransformJob(self, req):
        ...
        """
        self.send_cancelTransformJob(req)
        return self.recv_cancelTransformJob()

    def send_cancelTransformJob(self, req):
    ...
    def registerTask(self, req):
        ...
        """
        self.send_registerTask(req)
        return self.recv_registerTask()

    def send_registerTask(self, req):
        self._oprot.writeMessageBegin('registerTask', TMessageType.CALL, self._seqid)
        args = registerTask_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_registerTask(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = registerTask_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "registerTask failed: unknown result")
    ...
    def dropTask(self, req):
        ...
        """
        self.send_dropTask(req)
        return self.recv_dropTask()

    def send_dropTask(self, req):
        self._oprot.writeMessageBegin('dropTask', TMessageType.CALL, self._seqid)
        args = dropTask_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_dropTask(self):
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            iprot.readMessageEnd()
            raise x
        result = dropTask_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "dropTask failed: unknown result")
    ...
    def getRegisterTaskInfo(self, req):
        ...
        """
        self.send_getRegisterTaskInfo(req)
        return self.recv_getRegisterTaskInfo()

    def send_getRegisterTaskInfo(self, req):
        self._oprot.writeMessageBegin('getRegisterTaskInfo', TMessageType.CALL, self._seqid)
        args = getRegisterTaskInfo_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getRegisterTaskInfo(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = getRegisterTaskInfo_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
    ...
    def debugInfo(self, req):
        ...
        """
        self.send_debugInfo(req)
        return self.recv_debugInfo()

    def send_debugInfo(self, req):
        self._oprot.writeMessageBegin('debugInfo', TMessageType.CALL, self._seqid)
        args = debugInfo_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def showRules(self, req):
        ...
        """
        self.send_showRules(req)
        return self.recv_showRules()

    def send_showRules(self, req):
        self._oprot.writeMessageBegin('showRules', TMessageType.CALL, self._seqid)
        args = showRules_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_showRules(self):
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            iprot.readMessageEnd()
            raise x
        result = showRules_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "showRules failed: unknown result")
    ...
    def setRules(self, req):
        ...
        """
        self.send_setRules(req)
        return self.recv_setRules()

    def send_setRules(self, req):
        self._oprot.writeMessageBegin('setRules', TMessageType.CALL, self._seqid)
        args = setRules_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def executeSubPlan(self, req):
        ...
        """
        self.send_executeSubPlan(req)
        return self.recv_executeSubPlan()

    def send_executeSubPlan(self, req):
        self._oprot.writeMessageBegin('executeSubPlan', TMessageType.CALL, self._seqid)
        args = executeSubPlan_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_executeSubPlan(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = executeSubPlan_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "executeSubPlan failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["loadUDF"] = Processor.process_loadUDF
        ...
        self._processMap["executeSubPlan"] = Processor.process_executeSubPlan
    ...
    def process_loadUDF(self, seqid, iprot, oprot):
        args = loadUDF_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = loadUDF_result()
        try:
            result.success = self._handler.loadUDF(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("loadUDF", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_commitTransformJob(self, seqid, iprot, oprot):
        ...
        result = commitTransformJob_result()
        try:
            result.success = self._handler.commitTransformJob(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_queryTransformJobStatus(self, seqid, iprot, oprot):
        args = queryTransformJobStatus_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = queryTransformJobStatus_result()
        try:
            result.success = self._handler.queryTransformJobStatus(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("queryTransformJobStatus", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_cancelTransformJob(self, seqid, iprot, oprot):
        ...
        result = cancelTransformJob_result()
        try:
            result.success = self._handler.cancelTransformJob(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_registerTask(self, seqid, iprot, oprot):
        args = registerTask_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = registerTask_result()
        try:
            result.success = self._handler.registerTask(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("registerTask", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_dropTask(self, seqid, iprot, oprot):
        args = dropTask_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = dropTask_result()
        try:
            result.success = self._handler.dropTask(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("dropTask", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_getRegisterTaskInfo(self, seqid, iprot, oprot):
        args = getRegisterTaskInfo_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getRegisterTaskInfo_result()
        try:
            result.success = self._handler.getRegisterTaskInfo(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_debugInfo(self, seqid, iprot, oprot):
        args = debugInfo_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = debugInfo_result()
        try:
            result.success = self._handler.debugInfo(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_showRules(self, seqid, iprot, oprot):
        args = showRules_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = showRules_result()
        try:
            result.success = self._handler.showRules(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("showRules", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_setRules(self, seqid, iprot, oprot):
        args = setRules_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = setRules_result()
        try:
            result.success = self._handler.setRules(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_executeSubPlan(self, seqid, iprot, oprot):
        args = executeSubPlan_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = executeSubPlan_result()
        try:
            result.success = self._handler.executeSubPlan(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("executeSubPlan", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class loadUDF_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('loadUDF_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(loadUDF_args)
loadUDF_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [LoadUDFReq, None], None, ),  # 1
)


class loadUDF_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('loadUDF_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(loadUDF_result)
loadUDF_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [LoadUDFResp, None], None, ),  # 0
)
...
class commitTransformJob_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.req = CommitTransformJobReq()
                    self.req.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
...
commitTransformJob_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [CommitTransformJobReq, None], None, ),  # 1
)
...
class commitTransformJob_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = CommitTransformJobResp()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
...
commitTransformJob_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [CommitTransformJobResp, None], None, ),  # 0
)


class queryTransformJobStatus_args(object):
    """
    Attributes:
     - req
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.req = QueryTransformJobStatusReq()
                    self.req.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('queryTransformJobStatus_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(queryTransformJobStatus_args)
queryTransformJobStatus_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [QueryTransformJobStatusReq, None], None, ),  # 1
)


class queryTransformJobStatus_result(object):
    """
    Attributes:
     - success
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = QueryTransformJobStatusResp()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('queryTransformJobStatus_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(queryTransformJobStatus_result)
queryTransformJobStatus_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [QueryTransformJobStatusResp, None], None, ),  # 0
)
...
class cancelTransformJob_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.req = CancelTransformJobReq()
                    self.req.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
...
cancelTransformJob_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [CancelTransformJobReq, None], None, ),  # 1
)
...
class registerTask_args(object):
    """
    Attributes:
     - req
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('registerTask_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(registerTask_args)
registerTask_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [RegisterTaskReq, None], None, ),  # 1
)


class registerTask_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('registerTask_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(registerTask_result)
registerTask_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [Status, None], None, ),  # 0
)


class dropTask_args(object):
    """
    Attributes:
     - req
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('dropTask_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(dropTask_args)
dropTask_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [DropTaskReq, None], None, ),  # 1
)


class dropTask_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('dropTask_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(dropTask_result)
dropTask_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [Status, None], None, ),  # 0
)


class getRegisterTaskInfo_args(object):
    """
    Attributes:
     - req
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.req = GetRegisterTaskInfoReq()
                    self.req.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getRegisterTaskInfo_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getRegisterTaskInfo_args)
getRegisterTaskInfo_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [GetRegisterTaskInfoReq, None], None, ),  # 1
)


class getRegisterTaskInfo_result(object):
    """
    Attributes:
     - success
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = GetRegisterTaskInfoResp()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getRegisterTaskInfo_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
...
class debugInfo_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('debugInfo_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(debugInfo_args)
debugInfo_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [DebugInfoReq, None], None, ),  # 1
)


class debugInfo_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('debugInfo_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
...
class showRules_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('showRules_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(showRules_args)
showRules_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [ShowRulesReq, None], None, ),  # 1
)


class showRules_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('showRules_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(showRules_result)
showRules_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [ShowRulesResp, None], None, ),  # 0
)


class setRules_args(object):
    """
    Attributes:
     - req
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setRules_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(setRules_args)
setRules_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [SetRulesReq, None], None, ),  # 1
)


class setRules_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setRules_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
...
class executeSubPlan_args(object):
    """
    Attributes:
     - req
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('executeSubPlan_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(executeSubPlan_args)
executeSubPlan_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [ExecuteSubPlanReq, None], None, ),  # 1
)


class executeSubPlan_result(object):
    """
    Attributes:
     - success
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = ExecuteSubPlanResp()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('executeSubPlan_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(executeSubPlan_result)
executeSubPlan_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [ExecuteSubPlanResp, None], None, ),  # 0
)
