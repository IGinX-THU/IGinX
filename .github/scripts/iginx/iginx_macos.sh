...
#sed -i "" -E "s/default.transformer[0].include=.*/default.transformer[0].include=glob:**.denied/g" core/target/iginx-core-*/conf/file-permission.properties
...
while [ $elapsed_time -lt $timeout ]; do
  last_lines=$(tail -r -n 10 "$log_file")
