...
sh -c "sudo sed -i '' 's/# wal_buffer_size=16777216/wal_buffer_size=167772160/' apache-iotdb2-0.12.6-server-bin-$port/conf/iotdb-engine.properties"

sh -c "sudo sed -i '' 's/6667/$port/' apache-iotdb2-0.12.6-server-bin-$port/conf/iotdb-engine.properties"
