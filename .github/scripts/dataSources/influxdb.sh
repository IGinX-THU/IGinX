...
sed -i "s/your-token/testToken/g" core/target/iginx-core-0.6.0-SNAPSHOT/conf/config.properties

sed -i "s/your-organization/testOrg/g" core/target/iginx-core-0.6.0-SNAPSHOT/conf/config.properties
...
sed -i "s/#storageEngineList=127.0.0.1#8086/storageEngineList=127.0.0.1#8086/g" core/target/iginx-core-0.6.0-SNAPSHOT/conf/config.properties
