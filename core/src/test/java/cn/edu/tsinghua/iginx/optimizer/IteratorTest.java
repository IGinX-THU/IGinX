...
public class IteratorTest {
    ...
    public void testDeepFirstIterator() {
        ...
        expectedOrder = Arrays.asList(Reorder.class, Select.class, InnerJoin.class, Project.class, Project.class);
        Assert.assertTrue(matchExpectedOrder(expectedOrder, it));

        root = TreeBuilder.buildJoinTree1();
        it = new DeepFirstIterator(root);
        expectedOrder = Arrays.asList(Reorder.class, Select.class, OuterJoin.class, InnerJoin.class, Project.class, Select.class, Project.class, Project.class);
        Assert.assertTrue(matchExpectedOrder(expectedOrder, it));
    }
    ...
    public void testLeveledIterator() {
        ...
        root = TreeBuilder.buildJoinTree1();
        it = new LeveledIterator(root);
        expectedOrder = Arrays.asList(Reorder.class, Select.class, OuterJoin.class, InnerJoin.class, Project.class, Project.class, Select.class, Project.class);
        Assert.assertTrue(matchExpectedOrder(expectedOrder, it));
    }
