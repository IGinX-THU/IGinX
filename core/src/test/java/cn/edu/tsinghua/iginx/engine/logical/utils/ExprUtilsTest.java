...
public class ExprUtilsTest {
  ...
  public void testTimeRange() {
    ...
    assertEquals(
        Arrays.asList(new TimeRange(6, 11), new TimeRange(13, 15)), statement.getTimeRanges());
    ...
    statement = (DeleteStatement) TestUtils.buildStatement(delete);
    assertEquals(
        Collections.singletonList(new TimeRange(16, Long.MAX_VALUE)), statement.getTimeRanges());
    ...
    statement = (DeleteStatement) TestUtils.buildStatement(delete);
    assertEquals(
        Collections.singletonList(new TimeRange(0, Long.MAX_VALUE)), statement.getTimeRanges());
  }
  ...
  public void testGetSubFilterFromFragment() {
    ...
    assertEquals(
        "(key > 10 && key <= 100)",
        ExprUtils.getSubFilterFromFragment(filter, new TimeSeriesInterval("root.a", "root.c"))
            .toString());
    ...
    assertEquals(
        ...
        ExprUtils.getSubFilterFromFragment(filter, new TimeSeriesInterval("root.c", "root.z"))
            .toString());
    ...
    assertEquals(
        "((root.a > 5 || root.d < 15) && root.e >= 27 && (root.c < 10 || root.b > 2))",
        ExprUtils.getSubFilterFromFragment(filter, new TimeSeriesInterval("root.a", "root.z"))
            .toString());
    ...
    assertEquals(
        "True",
        ExprUtils.getSubFilterFromFragment(filter, new TimeSeriesInterval("root.h", "root.z"))
            .toString());
  }
}
