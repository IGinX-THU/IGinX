...
public class TreeInfoVisitor implements OperatorVisitor {
    ...
    public void visit(UnaryOperator unaryOperator) {
        makeRoomForSpacer();
        builder.append("[").append(unaryOperator.getType()).append("] ").append(unaryOperator.getInfo()).append("\n");
    }

    @Override
    public void visit(BinaryOperator binaryOperator) {
        makeRoomForSpacer();
        builder.append("[").append(binaryOperator.getType()).append("] ").append(binaryOperator.getInfo()).append("\n");
    }

    @Override
    public void visit(MultipleOperator multipleOperator) {
        makeRoomForSpacer();
        builder.append("[").append(multipleOperator.getType()).append("] ").append(multipleOperator.getInfo()).append("\n");
    }
