      ...
      switch (type) {
        ...
        case DOUBLE:
          ...
          for (int i = 0; i < n; i++) {
            ...
            if (i == n - 1
                || RestUtils.getInterval(sessionQueryDataSet.getKeys()[i], startTimestamp, getDur())
                    != RestUtils.getInterval(
                        sessionQueryDataSet.getKeys()[i + 1], startTimestamp, getDur())) {
              queryResultDataset.add(
                  RestUtils.getIntervalStart(
                      sessionQueryDataSet.getKeys()[i], startTimestamp, getDur()),
