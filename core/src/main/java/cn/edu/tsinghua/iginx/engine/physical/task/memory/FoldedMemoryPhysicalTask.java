...
//
//  @Override
//  public ArrowTaskResult execute() {
...
//        }
//      }
//      return new ArrowTaskResult(exception);
//    }
//
//    // 根据运行时结果生成最终操作树
...
//    } else {
//      throw new RuntimeException(
//          "The follow task of a FoldedMemoryPhysicalTask is expected a
// CompletedFoldedPhysicalTask.");
//    }
...
//              new OperatorSource(
//                  fillRootWithPath(
//                      ((OperatorSource) unaryOperator.getSource()).getOperator(),
// selectedPaths)));
