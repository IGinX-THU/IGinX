    ...
    fragmentMetas.sort(
        (o1, o2) -> {
          ...
          if (o1.getTimeInterval().getStartTime() == o2.getTimeInterval().getStartTime()) {
            ...
            return Long.compare(
                o1.getTimeInterval().getStartTime(), o2.getTimeInterval().getStartTime());
          }
        });
  ...
  protected void compactFragmentGroupToTargetStorageUnit(
    ...
    for (FragmentMeta fragmentMeta : fragmentGroup) {
      ...
      if (startTimeseries == null || fragmentMeta.getTsInterval().getStartTimeSeries() == null) {
        ...
        startTimeseries =
            startTimeseries.compareTo(fragmentMeta.getTsInterval().getStartTimeSeries()) > 0
        ...
        if (endTimeseries == null || fragmentMeta.getTsInterval().getEndTimeSeries() == null) {
          ...
          endTimeseries =
              endTimeseries.compareTo(fragmentMeta.getTsInterval().getEndTimeSeries()) > 0
                  ? endTimeseries
