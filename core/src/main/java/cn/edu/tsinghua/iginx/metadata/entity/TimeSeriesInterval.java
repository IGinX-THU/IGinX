...
public final class TimeSeriesInterval implements TimeSeriesRange {
  ...
  public boolean isContain(String tsName) {
    ...
    return (startTimeSeries == null
            || (tsName != null && StringUtils.compare(tsName, startTimeSeries, true) >= 0))
        && (endTimeSeries == null
            || (tsName != null && StringUtils.compare(tsName, endTimeSeries, false) < 0));
  }
  ...
  public boolean isIntersect(TimeSeriesRange tsInterval) {
    ...
    return (tsInterval.getStartTimeSeries() == null
            || endTimeSeries == null
            || StringUtils.compare(tsInterval.getStartTimeSeries(), endTimeSeries, false) < 0)
    ...
    String start =
        startTimeSeries == null
            ...
            : tsInterval.getStartTimeSeries() == null
                ? startTimeSeries
                : StringUtils.compare(tsInterval.getStartTimeSeries(), startTimeSeries, true) < 0
                    ? startTimeSeries
                    : tsInterval.getStartTimeSeries();
    String end =
        endTimeSeries == null
            ...
            : tsInterval.getEndTimeSeries() == null
                ? endTimeSeries
                : StringUtils.compare(tsInterval.getEndTimeSeries(), endTimeSeries, false) < 0
                    ? tsInterval.getEndTimeSeries()
                    : endTimeSeries;
