...
public interface BatchStream extends AutoCloseable {
  ...
  /**
   * Get the schema of the batch stream.
   * The schema is immutable, the caller should not modify the schema.
   * All the batches in the stream have the same schema.
   *
   ...
   * The batch is immutable, the caller should not modify the batch.
   * The caller should close the batch after using it.
   *
