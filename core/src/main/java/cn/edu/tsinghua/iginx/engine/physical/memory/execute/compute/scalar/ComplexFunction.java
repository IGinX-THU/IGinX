...
public abstract class ComplexFunction<OUTPUT extends FieldVector> extends AbstractFunction<OUTPUT> {
  ...
  protected OUTPUT invokeImpl(BufferAllocator allocator, VectorSchemaRoot input)
    ...
    return evaluate(allocator, input.getFieldVectors());
  }

  public abstract OUTPUT evaluate(
      @WillNotClose BufferAllocator allocator, @WillNotClose List<FieldVector> inputs)
      throws ComputeException;
}
