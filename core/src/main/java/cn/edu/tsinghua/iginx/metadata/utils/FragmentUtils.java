...
public class FragmentUtils {
    ...
    public static Pair<Map<TimeInterval, List<FragmentMeta>>, List<FragmentMeta>>
            keyFromTSIntervalToTimeInterval(
                    Map<TimeSeriesRange, List<FragmentMeta>> fragmentMapByTSInterval) {
                            ...
                            fragmentMeta -> {
                                ...
                                if (fragmentMapByTimeInterval.containsKey(
                                    ...
                                    fragmentMapByTimeInterval
                                            .get(fragmentMeta.getTimeInterval())
                                            .add(fragmentMeta);
                                } else {
