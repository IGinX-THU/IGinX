...
public class MetaManagerMock implements IMetaManager{
    ...
    private Map<ColumnsInterval, List<FragmentMeta>> getFragmentMapByColumnsIntervalMap = new HashMap<>();
    ...
    public void setGetFragmentMapByColumnsIntervalMap(Map<ColumnsInterval, List<FragmentMeta>> getFragmentMapByColumnsIntervalMap) {
        this.getFragmentMapByColumnsIntervalMap.clear();
        this.getFragmentMapByColumnsIntervalMap = getFragmentMapByColumnsIntervalMap;
    }

    @Override
    public Map<ColumnsInterval, List<FragmentMeta>> getFragmentMapByColumnsInterval(ColumnsInterval columnsInterval) {
        return getFragmentMapByColumnsInterval(columnsInterval, false);
    }

    @Override
    public Map<ColumnsInterval, List<FragmentMeta>> getFragmentMapByColumnsInterval(ColumnsInterval columnsInterval, boolean withDummyFragment) {
    ...
    @Override
    public Map<ColumnsInterval, FragmentMeta> getLatestFragmentMapByColumnsInterval(ColumnsInterval columnsInterval) {
        return null;
    }
    ...
    @Override
    public Map<ColumnsInterval, List<FragmentMeta>> getFragmentMapByColumnsIntervalAndKeyInterval(ColumnsInterval columnsInterval, KeyInterval keyInterval) {
        return null;
    }

    @Override
    public Map<ColumnsInterval, List<FragmentMeta>> getFragmentMapByColumnsIntervalAndKeyInterval(ColumnsInterval columnsInterval, KeyInterval keyInterval, boolean withDummyFragment) {
        return null;
    }
    ...
    @Override
    public List<FragmentMeta> getFragmentListByColumnNameAndKeyInterval(String colName, KeyInterval keyInterval) {
        return null;
    }
    ...
    @Override
    public void updateFragmentByColumnsInterval(ColumnsInterval columnsInterval, FragmentMeta fragmentMeta) {
