      ...
      for (String tsIntervalName : tsIntervalNames) {
        ...
        if (fragmentTimeSeries.isContain(tsName)) {
          ...
          List<String> timeIntervalNames =
              this.client.getChildren().forPath(FRAGMENT_NODE_PREFIX + "/" + tsIntervalName);
        ...
        (curatorFramework, event) -> {
          ...
          switch (event.getType()) {
            case NODE_UPDATED:
              ...
              fragmentMeta =
                  JsonUtils.fromJson(
                      JsonUtils.addType("tsInterval", "TimeSeriesInterval", data),
                      FragmentMeta.class);
            ...
            case NODE_ADDED:
              ...
              if (pathParts.length == 4) {
                fragmentMeta =
                    JsonUtils.fromJson(
                        JsonUtils.addType(
                            "tsInterval", "TimeSeriesInterval", event.getData().getData()),
                        FragmentMeta.class);
                if (fragmentMeta != null) {
      ...
      this.client
          ...
          .forPath(
              FRAGMENT_NODE_PREFIX
                  ...
                  + fragmentMeta.getTimeInterval().toString());
      List<String> timeIntervalNames =
          this.client.getChildren().forPath(FRAGMENT_NODE_PREFIX + "/" + tsInterval.toString());
