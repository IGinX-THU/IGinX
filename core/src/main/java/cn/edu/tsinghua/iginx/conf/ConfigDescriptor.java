...
public class ConfigDescriptor {
        ...
        try (InputStream in =
            ...
            config.setEnableFragmentCompaction(
                    Boolean.parseBoolean(
                            properties.getProperty("enableFragmentCompaction", "false")));
            config.setFragmentCompactionWriteThreshold(
                    Long.parseLong(
                            properties.getProperty("fragmentCompactionWriteThreshold", "1000")));
            config.setFragmentCompactionReadThreshold(
                    Long.parseLong(
                            properties.getProperty("fragmentCompactionReadThreshold", "1000")));
            ...
            config.setMaxTimeseriesLoadBalanceThreshold(
                    Double.parseDouble(
                            properties.getProperty("maxTimeseriesLoadBalanceThreshold", "2")));
            ...
            config.setDisorderMargin(
                    Long.parseLong(properties.getProperty("disorderMargin", "10")));
            ...
            config.setEtcdEndpoints(
                    properties.getProperty("etcdEndpoints", "http://localhost:2379"));

            config.setEnableMQTT(
                    Boolean.parseBoolean(properties.getProperty("enable_mqtt", "false")));
            ...
            config.setMqttPayloadFormatter(
                    properties.getProperty(
                            ...
                            "cn.edu.tsinghua.iginx.mqtt.JsonPayloadFormatter"));
            ...
            config.setPhysicalTaskThreadPoolSizePerStorage(
                    Integer.parseInt(
                            properties.getProperty("physicalTaskThreadPoolSizePerStorage", "100")));

            config.setMaxCachedPhysicalTaskPerStorage(
                    Integer.parseInt(
                            properties.getProperty("maxCachedPhysicalTaskPerStorage", "500")));
            ...
            config.setEnableStorageGroupValueLimit(
                    Boolean.parseBoolean(
                            properties.getProperty("enableStorageGroupValueLimit", "true")));
            ...
            config.setSystemResourceMetrics(
                    properties.getProperty("system_resource_metrics", "default"));
            ...
            config.setEnableMetaCacheControl(
                    Boolean.parseBoolean(
                            properties.getProperty("enable_meta_cache_control", "false")));
            ...
            config.setNeedInitBasicUDFFunctions(
                    Boolean.parseBoolean(
                            properties.getProperty("needInitBasicUDFFunctions", "false")));
    ...
    private void loadPropsFromEnv() {
        ...
        config.setZookeeperConnectionString(
                EnvUtils.loadEnv(
                        "zookeeperConnectionString", config.getZookeeperConnectionString()));
        config.setStorageEngineList(
        ...
        config.setStatisticsCollectorClassName(
                EnvUtils.loadEnv(
                        "statisticsCollectorClassName", config.getStatisticsCollectorClassName()));
        config.setStatisticsLogInterval(
        ...
        config.setMaxCachedPhysicalTaskPerStorage(
                EnvUtils.loadEnv(
                        ...
                        config.getMaxCachedPhysicalTaskPerStorage()));
        config.setCachedTimeseriesProb(
        ...
        config.setReAllocatePeriod(
                EnvUtils.loadEnv("reAllocatePeriod", config.getReAllocatePeriod()));
        config.setEnableStorageGroupValueLimit(
                EnvUtils.loadEnv(
                        "enableStorageGroupValueLimit", config.isEnableStorageGroupValueLimit()));
        config.setStorageGroupValueLimit(
        ...
        config.setTransformTaskThreadPoolSize(
                EnvUtils.loadEnv(
                        "transformTaskThreadPoolSize", config.getTransformTaskThreadPoolSize()));
        config.setTransformMaxRetryTimes(
                EnvUtils.loadEnv("transformMaxRetryTimes", config.getTransformMaxRetryTimes()));
        config.setNeedInitBasicUDFFunctions(
                EnvUtils.loadEnv(
                        "needInitBasicUDFFunctions", config.isNeedInitBasicUDFFunctions()));
    ...
    private void loadUDFListFromFile() {
        try (InputStream in =
                new FileInputStream(
                        EnvUtils.loadEnv(Constants.UDF_LIST, Constants.UDF_LIST_FILE))) {
