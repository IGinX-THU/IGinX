...
Since ZooKeeper, IGinX are all developed using Java, Java needs to be installed first. If a running environment of jdk >= 17 has been installed locally, **skip this step entirely**.
