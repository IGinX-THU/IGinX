...
public interface DeleteClient {
  ...
  void deleteMeasurement(final String measurement);

  void deleteMeasurements(final Collection<String> measurements);

  void deleteMeasurement(final Class<?> measurementType);
