...
import cn.edu.tsinghua.iginx.filesystem.thrift.FileSystemRpc;
...
public class Server implements AutoCloseable {
  ...
  public Server(InetSocketAddress address, Service service)
    ...
    TProcessor processor =
        new FileSystemRpc.Processor<FileSystemRpc.Iface>(new ServerWorker(service));
    ...
    ExecutorService executorService =
        new ThreadPoolExecutor(
            ...
            new ThreadFactoryBuilder()
                .setNameFormat("FileSystemServer(" + address + ")-%d")
                .build());
    ...
    new Thread(server::serve, "FileSystemServer(" + address + ")").start();
