...
import cn.edu.tsinghua.iginx.filesystem.struct.units.UnitsMerger;
...
public class StorageService implements Service {
  ...
  public StorageService(@Nullable StorageConfig dataConfig, @Nullable StorageConfig dummyConfig)
    ...
    try {
      ...
      close();
      throw new FileSystemException("failed to initialize storage service", e);
    }
  }
  ...
  public synchronized void close() throws FileSystemException {
    ...
    closed = true;
    FileSystemException exception = new FileSystemException("Failed to close storage service");
