...
public class ServerObjectMappingUtils {
  ...
  private static RawValue toRawValue(Value value) {
  ...
  public static RawDataType strToRawDataType(String type) {
  ...
  public static FunctionCall resolveRawFunctionCall(RawFunctionCall rawFunctionCall) {
  ...
  public static Function resolveRawFunction(RawFunction rawFunction) {
  ...
  public static FunctionParams resolveRawFunctionParams(RawFunctionParams rawFunctionParams) {
