...
import cn.edu.tsinghua.iginx.filestore.rpc.FileStoreService;
...
public class FileStoreServer {
  ...
  public FileStoreServer(InetSocketAddress address, Executor executor) throws TTransportException {
    serverTransport = new TServerSocket(address);
    TProcessor processor =
        new FileStoreService.Processor<FileStoreService.Iface>(new FileStoreServerWorker(executor));
