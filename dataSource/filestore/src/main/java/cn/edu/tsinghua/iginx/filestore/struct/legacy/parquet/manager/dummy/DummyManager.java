...
package cn.edu.tsinghua.iginx.filestore.legacy.parquet.manager.dummy;

import static cn.edu.tsinghua.iginx.filestore.legacy.parquet.util.Constants.SUFFIX_FILE_PARQUET;
...
public class DummyManager implements Manager {
  ...
  public RowStream project(List<String> paths, TagFilter tagFilter, Filter filter)
    ...
    List<cn.edu.tsinghua.iginx.filestore.legacy.parquet.manager.dummy.Column> columns =
