 ...
 */
package cn.edu.tsinghua.iginx.neo4j.entity;
...
import cn.edu.tsinghua.iginx.neo4j.tools.DataTransformer;
import cn.edu.tsinghua.iginx.neo4j.tools.TagKVUtils;
import cn.edu.tsinghua.iginx.thrift.DataType;
import cn.edu.tsinghua.iginx.utils.Pair;
import java.util.*;

public class Neo4jQueryRowStream implements RowStream {
  ...
  public Neo4jQueryRowStream(List<Column> columns, Filter filter) {
  ...
  public Neo4jQueryRowStream(List<Column> columns) {
    this(columns, null);
  }
