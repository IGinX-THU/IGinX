...
public class MilvusMeta extends AbstractVectorDBMeta {
  ...
  public MilvusMeta(StorageEngineMeta meta, Properties properties) {
    super(meta);
  ...
  public MilvusMeta(StorageEngineMeta meta, String propertiesPath) throws IOException {
  ...
  public MilvusMeta(StorageEngineMeta meta, InputStream propertiesIS) throws IOException {
