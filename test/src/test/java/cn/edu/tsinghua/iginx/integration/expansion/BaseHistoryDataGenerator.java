...
public abstract class BaseHistoryDataGenerator {
    ...
    public BaseHistoryDataGenerator() {
        seriesA.put("ln.wf01.wt01.status", new Pair<>(DataType.BOOLEAN, new ArrayList<Pair<Long, Object>>() {{
            add(new Pair<>(100L, true));
            add(new Pair<>(200L, false));
        }}));
        seriesA.put("ln.wf01.wt01.temperature", new Pair<>(DataType.DOUBLE, new ArrayList<Pair<Long, Object>>() {{
            add(new Pair<>(200L, 20.71));
        }}));

        seriesB.put("ln.wf03.wt01.status", new Pair<>(DataType.BOOLEAN, new ArrayList<Pair<Long, Object>>() {{
            add(new Pair<>(77L, true));
            add(new Pair<>(200L, false));
        }}));
        seriesB.put("ln.wf03.wt01.temperature", new Pair<>(DataType.DOUBLE, new ArrayList<Pair<Long, Object>>() {{
