...
public class FileSystemCapacityExpansionIT extends BaseCapacityExpansionIT {
  ...
  public FileSystemCapacityExpansionIT() {
    ...
    ORI_VALUES_LIST = Arrays.asList(Arrays.asList(value1, value2));
    READ_ONLY_DATA_TYPE_LIST = Arrays.asList(DataType.BINARY, DataType.BINARY);
    READ_ONLY_VALUES_LIST = Arrays.asList(Arrays.asList(value1, value2));
    EXP_VALUES_LIST1 = Arrays.asList(Arrays.asList(value1));
    EXP_VALUES_LIST2 = Arrays.asList(Arrays.asList(value2));
  }
