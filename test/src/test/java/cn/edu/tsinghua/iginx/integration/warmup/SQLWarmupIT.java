...
public class SQLWarmupIT implements AutoCloseable {
  ...
  private static final int WARMUP = Integer.getInteger("iginx.warmup.repeat", 3);
  private static final int RECORD = Integer.getInteger("iginx.warmup.records", 100000);
