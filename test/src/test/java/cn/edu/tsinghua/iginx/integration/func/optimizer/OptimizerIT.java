...
public class OptimizerIT {
        ...
        Arrays.asList(
            ...
            new Pair<>(
                ...
                "ResultSets:\n"
                    ...
                    + "|      +--Select             |          Select|                                                      Filter: (&mark30 == true)|\n"
                    + "|        +--MarkJoin         |        MarkJoin|Filter: True, MarkColumn: &mark30, IsAntiJoin: false, ExtraJoinPrefix: us.d1.s1|\n"
                    + "|          +--Select         |          Select|                                                        Filter: (us.d1.s1 < 10)|\n"
  ...
  public void testAggPushdown() {
    ...
    //    insert +=
    //        " VALUES (1, 1, 1.1, true, 1, 1.1, true), (2, 2, 2.2, false, 2, 2.2, false), (3, 1,
    // 2.2, true, 1, 1.1, true), (4, 2, 1.1, false, 2, 2.2, false);";
    //    executor.execute(insert);
    //
    ...
    //
    //    String statement =
    //        "SELECT sum(test.a.b) from test.a JOIN test.b on test.a.a = test.b.a group by
    // test.a.a;";
    ...
    //            +
    // "+------------------------+----------------+---------------------------------------------------------------------------------------------------------+\n"
    //            + "|            Logical Tree|   Operator Type|
    //                                                        Operator Info|\n"
    //            +
    // "+------------------------+----------------+---------------------------------------------------------------------------------------------------------+\n"
    //            + "|RemoveNullColumn        |RemoveNullColumn|
    //                                                     RemoveNullColumn|\n"
    //            + "|  +--Reorder            |         Reorder|
    //                                                 Order: sum(test.a.b)|\n"
    //            + "|    +--Rename           |          Rename|
    //                        AliasList: (sum(sum_test_a_b), sum(test.a.b))|\n"
    //            + "|      +--GroupBy        |         GroupBy|GroupByCols: test.a.a,
    // FuncList(Name, FuncType): (sum, System), MappingType: SetMapping isDistinct: false|\n"
    //            + "|        +--InnerJoin    |       InnerJoin|                         PrefixA:
    // test.a, PrefixB: test.b, IsNatural: false, Filter: test.a.a == test.b.a|\n"
    //            + "|          +--Rename     |          Rename|
    //                             AliasList: (sum(test.a.b), sum_test_a_b)|\n"
    //            + "|            +--GroupBy  |         GroupBy|GroupByCols: test.a.a,
    // FuncList(Name, FuncType): (sum, System), MappingType: SetMapping isDistinct: false|\n"
    //            + "|              +--Project|         Project|
    //               Patterns: test.a.a,test.a.b, Target DU: unit0000000002|\n"
    //            + "|          +--Project    |         Project|
    //                        Patterns: test.b.a, Target DU: unit0000000002|\n"
    //            +
    // "+------------------------+----------------+---------------------------------------------------------------------------------------------------------+\n"
    //            + "Total line number = 9\n";
    //
    ...
    //            + "|  +--Reorder      |         Reorder|
    //                                           Order: sum(test.a.b)|\n"
    //            + "|    +--GroupBy    |         GroupBy|GroupByCols: test.a.a, FuncList(Name,
    // FuncType): (sum, System), MappingType: SetMapping isDistinct: false|\n"
    //            + "|      +--InnerJoin|       InnerJoin|                         PrefixA: test.a,
    // PrefixB: test.b, IsNatural: false, Filter: test.a.a == test.b.a|\n"
    //            + "|        +--Project|         Project|
    //         Patterns: test.a.a,test.a.b, Target DU: unit0000000002|\n"
    //            + "|        +--Project|         Project|
    //                  Patterns: test.b.a, Target DU: unit0000000002|\n"
    ...
    //                                                    Order: sum(aaa)|\n"
    //            + "|    +--Rename         |          Rename|
    // AliasList: (test.a.a, aaa),(test.a.b, bbb),(sum(test.a.a), sum(aaa))|\n"
    //            + "|      +--Reorder      |         Reorder|
    //                                      Order: test.a.b,sum(test.a.a)|\n"
    //            + "|        +--Project    |         Project|
    //                                   Patterns: test.a.b,sum(test.a.a)|\n"
    //            + "|          +--GroupBy  |         GroupBy|GroupByCols: test.a.b, FuncList(Name,
    // FuncType): (sum, System), MappingType: SetMapping isDistinct: false|\n"
    //            + "|            +--Project|         Project|
    //             Patterns: test.a.a,test.a.b, Target DU: unit0000000002|\n"
    //            +
    ...
    //            + "|  +--Reorder          |         Reorder|
    //                                               Order: sum(aaa)|\n"
    //            + "|    +--GroupBy        |         GroupBy|GroupByCols: bbb, FuncList(Name,
    // FuncType): (sum, System), MappingType: SetMapping isDistinct: false|\n"
    //            + "|      +--Rename       |          Rename|
    //                    AliasList: (test.a.a, aaa),(test.a.b, bbb)|\n"
    //            + "|        +--Reorder    |         Reorder|
    //                                      Order: test.a.a,test.a.b|\n"
    //            + "|          +--Project  |         Project|
    //                                   Patterns: test.a.a,test.a.b|\n"
    //            + "|            +--Project|         Project|
    //        Patterns: test.a.a,test.a.b, Target DU: unit0000000002|\n"
    //            +
    // "+----------------------+----------------+----------------------------------------------------------------------------------------------------+\n"
    ...
    //                                             Order: sum(test.a.a)|\n"
    //            + "|    +--Reorder      |         Reorder|
    //                                    Order: test.b.b,sum(test.a.a)|\n"
    //            + "|      +--Project    |         Project|
    //                                 Patterns: test.b.b,sum(test.a.a)|\n"
    //            + "|        +--GroupBy  |         GroupBy|GroupByCols: test.b.b, FuncList(Name,
    // FuncType): (sum, System), MappingType: SetMapping isDistinct: false|\n"
    //            + "|          +--Project|         Project|
    //  Patterns: test.a.a,test.a.b,test.b.b, Target DU: unit0000000002|\n"
    //            +
    // "+--------------------+----------------+---------------------------------------------------------------------------------------------------------+\n"
    //            + "Total line number = 6\n";
    //    executor.execute(openRule);
    ...
    // FuncType): (sum, System), MappingType: SetMapping isDistinct: false|\n"
    //            + "|      +--Reorder      |         Reorder|
    //                                           Order: test.a.a,test.b.b|\n"
    //            + "|        +--Sort       |            Sort|
    //                                    SortBy: test.a.b, SortType: ASC|\n"
    //            + "|          +--Project  |         Project|
    //                               Patterns: test.a.a,test.a.b,test.b.b|\n"
    //            + "|            +--Project|         Project|
    //    Patterns: test.a.a,test.a.b,test.b.b, Target DU: unit0000000002|\n"
    //            +
    // "+----------------------+----------------+---------------------------------------------------------------------------------------------------------+\n"
    ...
    //
    //    statement =
    //        "SELECT sum(test.a.a) FROM (SELECT a, b, c FROM test.a UNION SELECT a, b, c FROM
    // test.b) GROUP BY test.a.b ORDER BY test.a.b;";
    //    explain = "EXPLAIN " + statement;
    //    expected =
    //        "ResultSets:\n"
    //            +
    ...
    //                                          SortBy: test.a.b, SortType: ASC|\n"
    //            + "|      +--Rename             |          Rename|
    //                           AliasList: (sum(sum(test.a.a)), sum(test.a.a))|\n"
    //            + "|        +--GroupBy          |         GroupBy|GroupByCols: test.a.b,
    // FuncList(Name, FuncType): (sum, System), MappingType: SetMapping isDistinct: false|\n"
    //            + "|          +--Union          |           Union|                  LeftOrder:
    // test.a.b,sum(test.a.a), RightOrder: test.b.b,sum(test.b.a), isDistinct: true|\n"
    //            + "|            +--Reorder      |         Reorder|
    //                                            Order: test.a.b,sum(test.a.a)|\n"
    //            + "|              +--Project    |         Project|
    //                                         Patterns: test.a.b,sum(test.a.a)|\n"
    ...
    //                   Patterns: test.a.a,test.a.b, Target DU: unit0000000002|\n"
    //            + "|            +--Reorder      |         Reorder|
    //                                            Order: test.b.b,sum(test.b.a)|\n"
    //            + "|              +--Project    |         Project|
    //                                         Patterns: test.b.b,sum(test.b.a)|\n"
    //            + "|                +--GroupBy  |         GroupBy|GroupByCols: test.b.b,
    // FuncList(Name, FuncType): (sum, System), MappingType: SetMapping isDistinct: false|\n"
    //            + "|                  +--Project|         Project|
    //                   Patterns: test.b.a,test.b.b, Target DU: unit0000000002|\n"
    //            +
    // "+----------------------------+----------------+---------------------------------------------------------------------------------------------------------+\n"
    //            + "Total line number = 14\n";
    //    executor.execute(openRule);
    ...
    // FuncList(Name, FuncType): (sum, System), MappingType: SetMapping isDistinct: false|\n"
    //            + "|        +--Union        |           Union|
    // LeftOrder: test.a.a,test.a.b, RightOrder: test.b.a,test.b.b, isDistinct: true|\n"
    //            + "|          +--Reorder    |         Reorder|
    //                                             Order: test.a.a,test.a.b|\n"
    //            + "|            +--Project  |         Project|
    //                                          Patterns: test.a.a,test.a.b|\n"
    ...
    //               Patterns: test.a.a,test.a.b, Target DU: unit0000000002|\n"
    //            + "|          +--Reorder    |         Reorder|
    //                                             Order: test.b.a,test.b.b|\n"
    //            + "|            +--Project  |         Project|
    //                                          Patterns: test.b.a,test.b.b|\n"
    //            + "|              +--Project|         Project|
    //               Patterns: test.b.a,test.b.b, Target DU: unit0000000002|\n"
    //            +
    // "+------------------------+----------------+---------------------------------------------------------------------------------------------------------+\n"
    ...
    //
    //    statement =
    //        "explain SELECT count(DISTINCT test.a.b), count(DISTINCT test.b.b) FROM (SELECT * FROM
    // test.a JOIN test.b ON test.a.a = test.b.a) GROUP BY test.a.a;";
    //    explain = "EXPLAIN " + statement;
    //    expected =
    //        "ResultSets:\n"
    //            +
    ...
    // RemoveNullColumn|\n"
    //            + "|  +--Reorder                |         Reorder|
    //                                        Order: count(distinct test.a.b),count(distinct
    // test.b.b)|\n"
    //            + "|    +--Reorder              |         Reorder|
    //                               Order: test.a.a,count(distinct test.a.b),count(distinct
    // test.b.b)|\n"
    //            + "|      +--Project            |         Project|
    //                            Patterns: test.a.a,count(distinct test.a.b),count(distinct
    // test.b.b)|\n"
    //            + "|        +--Rename           |          Rename|AliasList: (count(distinct
    // count_test_a_b), count(distinct test.a.b)),(count(distinct count_test_b_b), count(distinct
    // test.b.b))|\n"
    //            + "|          +--GroupBy        |         GroupBy|      GroupByCols: test.a.a,
    // FuncList(Name, FuncType): (count, System),(count, System), MappingType: SetMapping
    // isDistinct: true|\n"
    //            + "|            +--InnerJoin    |       InnerJoin|
    //                PrefixA: test.a, PrefixB: test.b, IsNatural: false, Filter: test.a.a ==
    // test.b.a|\n"
    //            + "|              +--Rename     |          Rename|
    //                                           AliasList: (count(distinct test.a.b),
    // count_test_a_b)|\n"
    //            + "|                +--GroupBy  |         GroupBy|
    // GroupByCols: test.a.a, FuncList(Name, FuncType): (count, System), MappingType: SetMapping
    // isDistinct: true|\n"
    //            + "|                  +--Project|         Project|
    //                                          Patterns: test.a.a,test.a.b, Target DU:
    // unit0000000002|\n"
    //            + "|              +--Rename     |          Rename|
    //                                           AliasList: (count(distinct test.b.b),
    // count_test_b_b)|\n"
    //            + "|                +--GroupBy  |         GroupBy|
    // GroupByCols: test.b.a, FuncList(Name, FuncType): (count, System), MappingType: SetMapping
    // isDistinct: true|\n"
    //            + "|                  +--Project|         Project|
    //                                          Patterns: test.b.a,test.b.b, Target DU:
    // unit0000000002|\n"
    //            +
    // "+----------------------------+----------------+--------------------------------------------------------------------------------------------------------------------------------+\n"
    //            + "Total line number = 13\n";
    ...
    //                                                                    RemoveNullColumn|\n"
    //            + "|  +--Reorder          |         Reorder|
    //                            Order: count(distinct test.a.b),count(distinct test.b.b)|\n"
    //            + "|    +--GroupBy        |         GroupBy|GroupByCols: test.a.a, FuncList(Name,
    // FuncType): (count, System),(count, System), MappingType: SetMapping isDistinct: true|\n"
    //            + "|      +--Reorder      |         Reorder|
    //                                                   Order: test.a.a,test.a.b,test.b.b|\n"
    //            + "|        +--Project    |         Project|
    //                                                Patterns: test.a.a,test.a.b,test.b.b|\n"
    //            + "|          +--InnerJoin|       InnerJoin|
    //    PrefixA: test.a, PrefixB: test.b, IsNatural: false, Filter: test.a.a == test.b.a|\n"
    //            + "|            +--Project|         Project|
    //                              Patterns: test.a.a,test.a.b, Target DU: unit0000000002|\n"
    //            + "|            +--Project|         Project|
    //                              Patterns: test.b.a,test.b.b, Target DU: unit0000000002|\n"
