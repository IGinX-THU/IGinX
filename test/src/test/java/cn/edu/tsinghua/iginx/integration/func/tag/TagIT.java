...
//    "insert into ah.hr03 (key, s[t1=v1,t2=vv2], v[t1=v1], v[t1=vv11]) values (3200, true, 16, 32);"
    ...
    // round 1
    List<String> pathList1 = Arrays.asList(
        "ah.hr01.s",
        "ah.hr01.s{t1=v1,t2=vv1}",
        "ah.hr01.v",
        "ah.hr01.v{t1=v2,t2=vv1}"
    );
    List<DataType> dataTypeList1 = Arrays.asList(
        DataType.LONG,
        DataType.LONG,
        DataType.LONG,
        DataType.LONG
    ...
    List<Map<String, String>> tagList1 = Arrays.asList(
        new HashMap<>(),
    ...
    List<List<Object>> valuesList1 = Arrays.asList(
    ...
    List<DataType> dataTypeList2 = Arrays.asList(
        DataType.BOOLEAN,
        DataType.BINARY
    );
    List<Long> keyList2 = Arrays.asList(100L);
    List<Map<String, String>> tagList2 = Arrays.asList(
        new HashMap<>(),
        new HashMap<>()
    );
    ...
    List<DataType> dataTypeList3 = Arrays.asList(
        DataType.BOOLEAN,
        DataType.BINARY
    );
    List<Long> keyList3 = Arrays.asList(400L);
    List<Map<String, String>> tagList3 = Arrays.asList(
        new HashMap<String, String>(){{
          put("t1", "v1");
        }},
        new HashMap<String, String>(){{
    ...
    List<String> pathList4 = Arrays.asList(
        "ah.hr02.v{t1=v1,t2=v2}"
    );
    List<DataType> dataTypeList4 = Arrays.asList(
        DataType.BINARY
    );
    List<Long> keyList4 = Arrays.asList(800L);
    List<Map<String, String>> tagList4 = Arrays.asList(
        new HashMap<String, String>(){{
          put("t1", "v1");
          put("t2", "v2");
        }}
    ...
    List<String> pathList5 = Arrays.asList(
        "ah.hr03.s{t1=vv1,t2=v2}",
        "ah.hr03.v{t1=vv11}"
    );
    List<DataType> dataTypeList5 = Arrays.asList(
        DataType.BOOLEAN,
        DataType.LONG
    );
    List<Long> keyList5 = Arrays.asList(1600L);
    List<Map<String, String>> tagList5 = Arrays.asList(
        new HashMap<String, String>(){{
          put("t1", "vv1");
          put("t2", "v2");
        }},
    ...
    List<String> pathList6 = Arrays.asList(
        "ah.hr03.s{t1=v1,t2=vv2}",
        "ah.hr03.v{t1=v1}",
        "ah.hr03.v{t1=vv11}"
    );
    List<DataType> dataTypeList6 = Arrays.asList(
        DataType.BOOLEAN,
        DataType.LONG,
        DataType.LONG
    );
    List<Long> keyList6 = Arrays.asList(3200L);
    List<Map<String, String>> tagList6 = Arrays.asList(
        new HashMap<String, String>(){{
          put("t1", "v1");
          put("t2", "vv2");
        }},
