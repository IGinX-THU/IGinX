...
public class RestIT {
  ...
  public String orderGen(String json, TYPE type) {
    ...
    if (type.equals(TYPE.DELETE_METRIC)) {
      ...
      ret.append(" http://127.0.0.1:6889/api/v1/metric/{");
      ret.append(json);
      ret.append("}");
    } else {
      ...
      if (type.equals(TYPE.QUERY)) {
        ret.append(" http://127.0.0.1:6889/api/v1/datapoints/query");
      } else if (type.equals(TYPE.INSERT)) {
        ret.append(" http://127.0.0.1:6889/api/v1/datapoints");
      } else if (type.equals(TYPE.DELETE)) {
        ret.append(" http://127.0.0.1:6889/api/v1/datapoints/delete");
      }
    }
    return ret.toString();
  }
