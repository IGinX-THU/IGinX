  ...
  public void testConstantFolding() {
    ...
    List<String> expressions =
        Arrays.asList(
            ...
            "(s2/6072 + s1*(s2 + (s2 + s1*(6076*s1/97 + 4092))/s1)/6072 + 4/253)/s2",
            "s2 + 60*s2*(s1 + 108)/s1 - 60*s1 + 91",
            "(-s2*2*(-s1 + 200*(-2*s1 - 83 - 108*s1/s2))/82 - s2/82 + s1/82 + 10/41)/s1",
            "32*s2/33 + 85*s1*(52*s2*(18*s2*s1*(-s1 - 54) + 18*s1) - 52*s2 + 1352)/33 + s1 + 706/33",
            "s1 - 60 + (149 + (s2 + (-s2 + 3*s1 - 90)/s2)/s2)/s2*2",
            "-s1 + (-s2 + 57*s1 + 57*(-1486*s2/1485 - 8*s1/297 + 79/45 - 41*s1*(-82 + (-s2 + 2*s1)/s2)/(1485*s2))/s2)/s1",
            "(-s2*(-28 + (s2*(s2 + s1*(-s2 - 15 - (-s1 + 9 + s1/s2*2)/(3*s1))) + 32)/s1)/95 - s2 + s1)/s1",
            "-s2*(s1*(-s2 - 47*s1/36 + 47*(s2 + s1 - 490)/(36*s2)) + 86)/1080 - s2/40 - 3*s1/40 - 1/2",
            "-s2 + s1*(-28*s2 - 14*s1 - 14*(-s2*(-2*s2 + 2*s1 - 91)/11 - 12*s2/11 + 287/11)/s1)",
