...
public abstract class SQLSessionIT {
    ...
    public void testSlideWindowByTimeQuery() {
        String statement =
            "SELECT %s(s1), %s(s4) FROM us.d1 OVER (RANGE 100 IN (0, 1000) STEP 50);";
        List<String> funcTypeList =
            Arrays.asList("MAX", "MIN", "FIRST_VALUE", "LAST_VALUE", "SUM", "AVG", "COUNT");
        List<String> expectedList =
            Arrays.asList(
    ...
    public void testAlias() {
        // time series alias
        String statement =
            "SELECT s1 AS rename_series, s2 FROM us.d1 WHERE s1 >= 1000 AND s1 < 1010;";
        String expected =
            "ResultSets:\n"
                + "+----+-------------+--------+\n"
    ...
    public void testFromSubQuery() {
        String insert =
            "INSERT INTO test(key, a.a, a.b) VALUES (1, 1, 1.1), (2, 3, 3.1), (3, 7, 7.1);";
        executor.execute(insert);
        insert =
            "INSERT INTO test(key, b.a, b.b) VALUES (1, 2, \"aaa\"), (3, 4, \"ccc\"), (5, 6, \"eee\");";
        executor.execute(insert);
        insert =
            "INSERT INTO test(key, c.a, c.b) VALUES (2, \"eee\", false), (3, \"aaa\", true), (4, \"bbb\", false);";
        executor.execute(insert);
        ...
        statement =
            "SELECT * FROM (SELECT test.a.a, test.b.a FROM test.a, test.b WHERE test.b.a < 6 AND test.a.a > 1 AS sub_query);";
        expected =
            "ResultSets:\n"
                + "+------------------+------------------+\n"
        ...
        statement =
            "SELECT * FROM test.a, (SELECT a FROM test.b WHERE test.b.a < 6), (SELECT b FROM test.c WHERE test.c.b = false);";
        expected =
            "ResultSets:\n"
                + "+--------+--------+----------+--------+----------+--------+----------+\n"
    ...
    public void testSelectSubQuery() {
        ...
        statement =
            "SELECT test.a.a, test.c.a FROM test.a INNER JOIN test.c ON test.a.d = test.c.d";
        expected =
            "ResultSets:\n"
                + "+--------+--------+\n"
                + "|test.a.a|test.c.a|\n"
    ...
    public void testErrorClause() {
        ...
        executor.executeAndCompareErrMsg(errClause,
            "Group by can not use SetToSet and RowToRow functions.");
    }
    ...
    public void testConcurrentQuery() {
        List<Pair<String, String>> statementsAndExpectRes = Arrays.asList(
            new Pair<>(
                "SHOW TIME SERIES",
                "Time series:\n"
                    + "+--------+--------+\n"
