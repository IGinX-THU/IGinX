...
public class TransformIT {
    ...
    static {
        ...
        TASK_MAP.put(
                "SleepTransformer", OUTPUT_DIR_PREFIX + File.separator + "transformer_sleep.py");
    }
    ...
    public void commitSingleSqlStatementByYamlTest() {
        ...
        try {
            String yamlFileName =
                    OUTPUT_DIR_PREFIX + File.separator + "TransformSingleSqlStatement.yaml";
    ...
    public void commitMultipleSqlStatementsByYamlTest() {
        ...
        try {
            ...
            String outputFileName =
                    OUTPUT_DIR_PREFIX
                            + File.separator
                            + "export_file_multiple_sql_statements_by_yaml.txt";
            SessionExecuteSqlResult result =
                    session.executeSql(String.format(COMMIT_SQL_FORMATTER, yamlFileName));
            long jobId = result.getJobId();
    ...
    public void commitSinglePythonJobByYamlTest() {
        ...
        try {
            ...
            String yamlFileName =
                    OUTPUT_DIR_PREFIX + File.separator + "TransformSinglePythonJob.yaml";
            String outputFileName =
                    OUTPUT_DIR_PREFIX
                            + File.separator
                            + "export_file_single_python_job_by_yaml.txt";
            SessionExecuteSqlResult result =
                    session.executeSql(String.format(COMMIT_SQL_FORMATTER, yamlFileName));
            long jobId = result.getJobId();
    ...
    public void commitMultiplePythonJobsByYamlTest() {
        ...
        try {
            ...
            String yamlFileName =
                    OUTPUT_DIR_PREFIX + File.separator + "TransformMultiplePythonJobs.yaml";
            String outputFileName =
                    OUTPUT_DIR_PREFIX
                            + File.separator
                            + "export_file_multiple_python_jobs_by_yaml.txt";
            SessionExecuteSqlResult result =
                    session.executeSql(String.format(COMMIT_SQL_FORMATTER, yamlFileName));
            long jobId = result.getJobId();
    ...
    public void commitMixedPythonJobsByYamlTest() {
        ...
        try {
            ...
            String yamlFileName =
                    OUTPUT_DIR_PREFIX + File.separator + "TransformMixedPythonJobs.yaml";
            String outputFileName =
                    OUTPUT_DIR_PREFIX
                            + File.separator
                            + "export_file_mixed_python_jobs_by_yaml.txt";
            SessionExecuteSqlResult result =
                    session.executeSql(String.format(COMMIT_SQL_FORMATTER, yamlFileName));
            long jobId = result.getJobId();
    ...
    public void commitMixedPythonJobsByYamlWithRegisterTest() {
        ...
        try {
            ...
            String yamlFileName =
                    OUTPUT_DIR_PREFIX
                            + File.separator
                            + "TransformMixedPythonJobsWithRegister.yaml";
            String outputFileName =
                    OUTPUT_DIR_PREFIX
                            + File.separator
