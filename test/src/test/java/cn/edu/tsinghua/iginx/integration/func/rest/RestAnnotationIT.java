...
public class RestAnnotationIT {
  ...
  private static final String[] API = {
    " http://127.0.0.1:6889/api/v1/datapoints/annotations/add",
    " http://127.0.0.1:6889/api/v1/datapoints/annotations/update",
    " http://127.0.0.1:6889/api/v1/datapoints/annotations",
    " http://127.0.0.1:6889/api/v1/datapoints/query/annotations",
    " http://127.0.0.1:6889/api/v1/datapoints/query/annotations/data",
    " http://127.0.0.1:6889/api/v1/datapoints/annotations/delete",
  };
