...
public class IoTDBHistoryDataGenerator extends BaseHistoryDataGenerator {
  ...
  public void writeHistoryDataToB() throws Exception {
    ...
    session.executeNonQueryStatement(
        "INSERT INTO root.ln.wf03.wt01(timestamp,status,temperature) values(200,false,77.71);");
  ...
  public void extraDataWriteToB() throws Exception {
    ...
    session.executeNonQueryStatement(
        "INSERT INTO root.test.wf03.wt01(timestamp,status) values(77,true);");
    session.executeNonQueryStatement(
        "INSERT INTO root.test.wf03.wt01(timestamp,status,temperature) values(200,false,77.71);");
