...
public class IParquetReader implements AutoCloseable {
  ...
  private IParquetReader(ParquetRecordReader<IRecord> internalReader, MessageType schema) {
  ...
  public static class Builder {
    ...
    public IParquetReader build() throws IOException {
      ...
      if (skip) {
        return new IParquetReader(requestedSchema);
      }
      ...
      return new IParquetReader(internalReader, requestedSchema);
    }
